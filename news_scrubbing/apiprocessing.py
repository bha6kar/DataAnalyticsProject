...
aylien_news_api.configuration.api_key['X-AYLIEN-NewsAPI-Application-ID'] = 'f78shi'
# Configure API key authorization: app_key
aylien_news_api.configuration.api_key['X-AYLIEN-NewsAPI-Application-Key'] = 'dfd78hjdujd99sdfMvdf90df'
...
print('************')
print("Fetched %d stories published between %s and %s" %
